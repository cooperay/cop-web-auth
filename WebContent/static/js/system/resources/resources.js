...
function getbaseList(){
	JY.Model.loading();
	JY.Ajax.doRequest("",jypath +'/backstage/resources/listAllParentMenu',null,function(data){
...
function loadPreResources(){
	JY.Ajax.doRequest(null,jypath +'/backstage/resources/listResources',null,function(data){
		if(data.res==1){  
		   //获取数据
		   var zNodes=data.obj;
		   //设置
...
function setForm(data){
	...
	$("#auForm input[name$='parentId']").val(JY.Object.notEmpty(l.parentId));//上级资源
