			...
			<table cellspacing="0" cellpadding="0" border="0" class="customTable">
				<tbody>
					...
					<tr class="FormData">
						...
						<td class="DataTD">&nbsp;
						<input type="text" jyValidate="required,ennum" role="textbox" maxlength="32" name="jobGroup" class="FormElement ui-widget-content ui-corner-all"></td>
					</tr>
					<tr class="FormData">
						<td class="CaptionTD"><font color="red">*</font>任务名：</td>
						<td class="DataTD">&nbsp;
						<input type="text" jyValidate="required,ennum" role="textbox" maxlength="32" name="jobName" class="FormElement ui-widget-content ui-corner-all"></td>
					</tr>
					<tr class="FormData">
						<td class="CaptionTD"><font color="red">*</font>任务别名：</td>
						<td class="DataTD">&nbsp;
						<input type="text" jyValidate="required" role="textbox" maxlength="32" name="aliasName" class="FormElement ui-widget-content ui-corner-all"></td>
					</tr>
					<tr class="FormData">
						<td class="CaptionTD"><font color="red">*</font>任务类Class：</td>
						<td class="DataTD">&nbsp;
						<input type="text" jyValidate="required" role="textbox" maxlength="64" name="jobClass" class="FormElement ui-widget-content ui-corner-all"></td>
					</tr>
					<tr class="FormData">
						<td class="CaptionTD"><font color="red">*</font>执行方式 ：</td>
						<td class="DataTD">&nbsp;
						<input type="text" jyValidate="required" role="textbox" maxlength="32" name="cronExpression" class="FormElement ui-widget-content ui-corner-all"></td>
					</tr>
