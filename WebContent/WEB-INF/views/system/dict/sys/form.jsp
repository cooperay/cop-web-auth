			...
			<table cellspacing="0" cellpadding="0" border="0" class="customTable">
				<tbody>
					...
					<tr class="FormData">
						...
						<td class="DataTD">&nbsp;
						<input type="text" jyValidate="required" role="textbox" maxlength="64" name="paramName" class="FormElement ui-widget-content ui-corner-all"></td>
					</tr>
					<tr class="FormData">
						<td class="CaptionTD"><font color="red">*</font>参数键(k)：</td>
						<td class="DataTD">&nbsp;
						<input type="text" jyValidate="required" role="textbox" maxlength="32" name="paramKey" class="FormElement ui-widget-content ui-corner-all"></td>
					</tr>
					<tr class="FormData">
						<td class="CaptionTD"><font color="red">*</font>参数值(v)：</td>
						<td class="DataTD">&nbsp;
						<input type="text" jyValidate="required" role="textbox" maxlength="64" name="paramValue" class="FormElement ui-widget-content ui-corner-all"></td>
					</tr>
